                            ...
                            <div class="col-lg-6">
                                ...
                                <form role="form" action="finaladdedcampaign.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="cname" value='<?php echo $row['cname']; ?>'
                                               required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Enter Here" name="oname"
                                               value='<?php echo $row['oname']; ?>' required>
                                    </div>

                                    <div class="form-group">
                                        <label>Phone Number</label>
                                        <input class="form-control" placeholder="Enter DOB" name="phn"
                                               value='<?php echo $row['phn']; ?>' required>
                                    </div>

                                    <div class="form-group">
                                        <label>Campaign Date</label>
                                        <input class="form-control" placeholder="Enter Weight" name="cdate"
                                               value='<?php echo $row['cdate']; ?>' required>
                                    </div>

                                    <div class="form-group">
                                        <label>Description</label>
                                        <input class="form-control" placeholder="Enter Here" name="descp"
                                               value='<?php echo $row['descp']; ?>' required>
                                    </div>
